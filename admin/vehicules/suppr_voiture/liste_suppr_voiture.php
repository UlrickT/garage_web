...
<html lang="fr">
    ...
    <body>
        ...
        <h1 class="titre">Supprimer un véhicule de la liste</h1>
        ...
        while ($voiture = $listeVoiture->fetch_assoc()) {
            ...
            //Recupere l'id de la voiture à supprimer
            echo '<tr>';
            echo '<td>
            ...
            <td>
            <a class="bouton_suppr" href="suppr_voiture.php?id='.$voiture['id_voiture'].'"><img src="../icons/trash.png" width="25" height="25"></a>
            </td>'; 
            echo '</tr>';
        }        
        ?>
